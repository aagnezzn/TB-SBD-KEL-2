    ...
    <div class="max-w-[1340px] mx-auto px-4 flex flex-col md:flex-row gap-8 relative">
                ...
                <div class="relative w-full h-[210px] bg-gray-100">
                    @if($course->image_url)
                        <img 
                            ...
                            alt="{{ $course->title }}"
                            onerror="this.onerror=null; this.src='/assets/images/education.jpg';">
                    @else
                        <img 
        ...
        <div class="p-6">
            ...
            <a href="{{ route('cart.add', $course->id) }}" 
                class="w-full bg-[#a435f0] text-white font-bold py-3 mb-2 hover:bg-[#8710d8] transition block text-center">
            ...
            <ul class="text-sm text-gray-600 space-y-2">
                ...
                <div class="p-6">
                    ...
                    <h4 class="font-bold text-sm mb-2">Kursus ini mencakup:</h4>
                    <ul class="text-sm text-gray-600 space-y-2">
                        <li>✓ Materi teks terstruktur {{ $course->lessons->sum('duration') }} menit</li>
                        <li>✓ {{ $course->lessons->count() }} materi pelajaran</li>
                        <li>✓ Akses seumur hidup</li>
                        <li>✓ Sertifikat penyelesaian</li>
                    </ul>
