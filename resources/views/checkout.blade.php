        ...
        <form action="{{ route('checkout.store') }}" method="POST">
            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="w-full lg:w-[35%]">
                    <div class="bg-white border border-[#d1d7dc] p-6 sticky top-4">
                        ...
                        <button type="submit" class="w-full bg-[#a435f0] hover:bg-[#8710d8] text-white py-4 font-bold text-lg transition-colors mb-4">
                            Selesaikan Pembayaran
                        </button>
                        
                        <p class="text-[10px] text-center text-[#6a6f73]">Jaminan Uang Kembali 30 Hari</p>
                    </div>
                </div>
            </div>
        </form>
