...
<header class="h-16 bg-[#a435f0] border-b border-white/20 flex items-center justify-between px-8 sticky top-0 z-10 shrink-0 shadow-md">
    ...
    <div class="flex items-center gap-6">
        <span class="text-sm font-semibold text-white/90">
            <i class="fas fa-user-circle mr-1"></i> Halo, Admin!
        </span>
        
        <form action="{{ route('logout') }}" method="POST" class="inline">
            @csrf
            <button type="submit" class="text-xs font-black bg-white/20 hover:bg-white/40 text-white px-4 py-2 rounded-lg border border-white/30 transition-all flex items-center gap-2">
