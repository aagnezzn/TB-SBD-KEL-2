<nav class="bg-white border-b border-gray-200 px-6 py-2 flex items-center h-16 w-full relative">
 ...
 <div class="relative group inline-block font-sans">
    
    <button class="px-4 py-2 text-sm font-medium hover:text-purple-700 transition-colors">
        Jelajahi
    </button>

    <div class="absolute left-0 top-full w-[280px] min-h-[350px] bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
        <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Telusuri Berdasarkan target</h4>
                    ...
                    <ul>
                        ...
                        <li class="group/level3">
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Rekayasa Prompt</a></li>
                        ...
                        <li class="group/level3">
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Chat GPT</a></li>
                                    ...
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">Pembuatan Konten AI</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">Preplexity AI</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">Agentforce</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">DeepSeek</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">MLOps</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">TensorFlow</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            AI Untuk Pengembangan <span>&rsaquo;</span>
                            </a>

                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">OpenAI API</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">GitHub Copilot</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pembelajaran Mesin Azure</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Retrieval-Augmented Generation (RAG)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">LangChain</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">MLOps</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">TensorFlow</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">PyTorch</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            AI Untuk Materi Kreatif <span>&rsaquo;</span>
                            </a>

                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">DALL·E</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Midjourney</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Stable Diffusion</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Leonardo.Ai</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pembuatan Seni AI</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <li class="group/level2">
                ...
                <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level2:opacity-100 group-hover/level2:visible transition-all duration-200">
                    <ul>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Pengembangan Web <span>&rsaquo;</span>
                            </a>

                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">JavaScript</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">React JS</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Angular</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">TypeScript</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">ASP.NET Core</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Kecerdasan Buatan</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Next.js</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Node.Js</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Model Bahasa Besar (LLM)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pembelajaran Mesin</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">AI Generatif (GenAI)</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">Python</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">LangChain</a></li>
                                    <li><a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:text-purple-700">Pembelajaran Mendalam</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Pengembangan Seluler <span>&rsaquo;</span>
                            </a>

                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Google Flutter</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Dart (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">React Native</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pengembangan iOS</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Swift</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">SwiftUI</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pengembangan Aplikasi Seluler</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Kotlin</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Bahasa Pemrograman <span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Java</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">C# (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">C++ (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">React JS</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Go (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">C (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Rust (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Spring Framework</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Pengembangan Game<span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Dasar-Dasar Pengembangan Game</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pengembangan Game 3D</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">C# (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Godot</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pengembangan Game 2D</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">C++ (bahasa pemrograman)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Cetak Biru Unreal Engine</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Desain dan Pengembangan Database<span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">MySQL</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Sistem Manajemen Database (DBMS)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">PostgreSQL</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">SQL Server</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Apache Kafka</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Oracle SQL</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">MongoDB</a></li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Pengujian Perangkat Lunak<span>&rsaquo;</span>
                            </a>

                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                <h4 class="px-6 py-3 text-xs font-bold text-gray-400 uppercase border-b border-gray-100">Topik Populer</h4>
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Microsoft Playwright</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">AI Agents & Agentic AI</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">ISTQB Certified Tester Foundation Level (CTFL)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Selenium WebDriver</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Pengujian Otomatis</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Postman</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Java</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Kecerdasan Buatan (AI)</a></li>
                                </ul>
                            </div>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Rekayasa Perangkat Lunak<span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">AI Agents & Agentic AI</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Arsitektur Perangkat Lunak</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Spring Framework</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Struktur Data</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Certified Kubernetes Application Developer (CKAD)</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Algoritme</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Layanan Mikro</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Spring AI</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Wawancara Coding</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Alat Pengembangan Perangkat Lunak<span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Rekayasa Prompt</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Docker</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">GitHub Copilot</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Git</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">OpenAI Codex</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Kubernetes</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">GitHub</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">CI/CD</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="group/level3">
                            <a href="#" class="px-6 py-3 flex justify-between items-center text-sm text-gray-700 hover:bg-gray-50 hover:text-purple-700 font-medium">
                            Pengembangan Tanpa Kode<span>&rsaquo;</span>
                            </a>
                            ...
                            <div class="absolute top-0 left-full w-[280px] min-h-full bg-white border border-gray-200 shadow-xl opacity-0 invisible group-hover/level3:opacity-100 group-hover/level3:visible transition-all duration-200">
                                ...
                                <ul class="py-2">
                                    ...
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">AI Agents & Agentic AI</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Vibe Coding</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Microsoft Copilot</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Microsoft Power Apps</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">WordPress</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Microsoft Power Platform</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Microsoft Power Automate</a></li>
                                    <li><a href="#" class="block px-6 py-3 text-sm text-gray-700 hover:text-purple-700">Produktivitas Kantor</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
     ...
     @click.self="openModal = false">
        ...
        <div x-show="openModal" 
            ...
            <div class="grid grid-cols-4 gap-y-4 gap-x-2">
                ...
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">العربية</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">日本語</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">Русский</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2"></a>

                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">Deutsch</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">한국어</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2 font-bold">ภาษาไทย</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2"></a>

                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">Español</a>
                <a href="#" class="text-sm text-gray-700 hover:text-purple-700 p-2">Nederlands</a>
