<nav class="bg-white border-b border-gray-200 px-6 py-2 flex items-center h-16 w-full relative">
    ...
    <button class="px-3 py-2 text-sm font-medium hover:text-purple-700 transition-colors">
        Jelajahi
    </button>
    ...
    <div x-show="showMenu" 
        ...
        <div class="w-1/3 border-r border-gray-100 py-4 bg-white">
            ...
            <ul>
                <li @mouseenter="level1 = 'ai'; level2 = ''" :class="level1 === 'ai' ? 'bg-gray-50 text-purple-700 font-bold' : ''" class="px-6 py-3 flex justify-between cursor-pointer text-sm hover:bg-gray-50">Pelajari AI <span>&rsaquo;</span></li>
                <li @mouseenter="level1 = 'dev'; level2 = ''" :class="level1 === 'dev' ? 'bg-gray-50 text-purple-700 font-bold' : ''" class="px-6 py-3 flex justify-between cursor-pointer text-sm hover:bg-gray-50">Pengembangan <span>&rsaquo;</span></li>
            </ul>
        </div>

        <div class="w-1/3 border-r border-gray-100 py-4 bg-gray-50/30">
            <div x-show="level1 === 'ai'">
                <li @mouseenter="level2 = 'dasar'" :class="level2 === 'dasar' ? 'text-purple-700 font-bold' : ''" class="px-6 py-2 text-sm cursor-pointer hover:text-purple-700">Dasar-Dasar AI</li>
                <li @mouseenter="level2 = 'profesional'" :class="level2 === 'profesional' ? 'text-purple-700 font-bold' : ''" class="px-6 py-2 text-sm cursor-pointer hover:text-purple-700">AI Untuk Profesional</li>
            </div>
        </div>
